...
func (m *UserMutation) SetFail(u user.Fail) {
	m.fail = &u
}

// Fail returns the value of the "fail" field in the mutation.
func (m *UserMutation) Fail() (r user.Fail, exists bool) {
	v := m.fail
	if v == nil {
		return
	}
...
// OldFail returns the old "fail" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldFail(ctx context.Context) (v user.Fail, err error) {
...
func (m *UserMutation) Fields() []string {
	...
	if m.fail != nil {
		fields = append(fields, user.FieldFail)
	}
	return fields
}
